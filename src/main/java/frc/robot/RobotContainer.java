  ...
  */
  private RobotContainer() {
    ...
    // Configure autonomous sendable chooser
      ...
      // Test Drive code
    m_chooser.setDefaultOption("driveforward", new cmdDriveStraight(24,.25,0.0));
    ...
    SmartDashboard.putData("driveforward", new cmdDriveStraight(24,.25,0.0));
    SmartDashboard.putData("driveback", new cmdDriveStraight(-24, .25, 0.0));
    ...
    SmartDashboard.putData("strafe left", new cmdStrafe(12, .25, 0.0));
    SmartDashboard.putData("strafe right", new cmdStrafe(-12, .25, 0.0));
